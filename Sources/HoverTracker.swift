...
/// Hover reporting that survives redraws. SwiftUI's onHover reinstalls its
/// tracking area whenever the view it sits on is re-evaluated, and AppKit answers
/// a fresh tracking area with an exit, so any state driven by the hover flickers.
